...
contract ClaimAirdrop is Script {
    address CLAIMING_ADDRESS = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; //second address in input file: Anvil address
    ...
    function splitSignature(
        ...
        } // 32+32+1 = length of v, r and s
        assembly {
            r := mload(add(sig, 32)) // odered according to the signature. r,s,v instead of v,r,s
            s := mload(add(sig, 64))
