...
contract SendPackedUserOp is Script {
        ...
        returns (PackedUserOperation memory)
    {
        ...
        PackedUserOperation memory userOp = _generateUnsignedUserOperation(callData, minimalAccount, nounce);
        // 2. get user op hash
    ...
    function _generateUnsignedUserOperation(bytes memory callData, address sender, uint256 nonce)
        internal
        pure
        returns (PackedUserOperation memory /* without the signature */ )
    {
        ...
        return PackedUserOperation({
            sender: sender,
            nonce: nonce,
            initCode: hex"", //ignore: not initializing any contract
            callData: callData,
